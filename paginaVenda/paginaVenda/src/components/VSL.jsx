        ...
        >
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-12 py-4 text-lg font-bold rounded-lg shadow-2xl w-full sm:w-auto"
            >
              Ver Planos
            </motion.button>
            
            <motion.a
              href="https://wa.me/5543999748808?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20o%20CineStream"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-12 py-4 text-lg font-bold rounded-lg shadow-2xl flex items-center gap-2 w-full sm:w-auto justify-center"
            >
